const SECTIONS = [
  {
    ...
    body: 'When you use Tracksy, we record anonymous usage events — things like "sort applied" or "playlist selected". These events contain only counts and category labels. No track names, playlist names, Spotify usernames, or account IDs are ever included.',
  },
  {
  ...
  },
  {
    ...
    body: 'Events are sent to PostHog, our analytics provider. PostHog processes data on EU servers (eu.i.posthog.com). No data is sold or shared with any other third party.',
  },
  {
  ...
  {
    title: 'Your rights',
    body: 'Under GDPR you have the right to access, correct, or delete your data, and to object to processing. You can opt out of analytics at any time in Settings — your preference is stored locally in your browser and respected immediately.',
  },
  {
    title: 'Contact',
